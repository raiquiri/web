...
const AdminMenuLink = ({ item, index }) => {
  ...
  const handleTitleData = (e) => {
    ...
    headerContext.menuData[index].title = e.target.value;
  };
  const handleTypeData = (e) => {
    setTypeData(e.target.value);
    headerContext.menuData[index].src = e.target.value;
  };
  const handleHrefData = (e) => {
    setHrefData(e.target.value);
    headerContext.menuData[index].href = e.target.value;
  };
  ...
  return (
    <div className="admin_container__block">
      ...
      {menuData.map((item, index) => (
        <AdminMenuLink key={index} item={item} index={index}/>
      ))}
    </div>
  );
};
